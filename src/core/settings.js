...
const FIELDS = [
  ...
  { id: 'pixelSortToggle', kind: 'checkbox' },
  { id: 'pixelSortAxis', kind: 'select' },
  { id: 'pixelSortWindow', kind: 'range' },
  { id: 'pixelSortLow', kind: 'range' },
  { id: 'pixelSortHigh', kind: 'range' },
  { id: 'pixelSortReverse', kind: 'checkbox' },
